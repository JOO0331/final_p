...
class Game(models.Model):
    ...
    name_eng = models.CharField(max_length=200, db_index=True)
...
#     game = models.OneToOneField(Game, on_delete=models.CASCADE, related_name='youtube')
#     title = models.CharField(max_length=200, db_index=True)
#     thumbnails = models.URLField()
#     publishedAt = models.DateTimeField(db_index=True)
#     channelTitle = models.CharField(max_length=100, db_index=True)
#     viewCount = models.BigIntegerField(default=0) #하루 한번 업데이트
...
#
#     def __str__(self):
#         return f"{self.title} ({self.channelTitle})"
